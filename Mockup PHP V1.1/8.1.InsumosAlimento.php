...
<center><h2>Insumos  - Alimento</h2></center></td>
...
<table width="340" border="0">
    <tr>
      <th width="73" scope="row"><div align="right">Tipo<font color ="red" >*</font></div></th>
      <td width="142"><select style="color:white; background-color: #000000">
      		<option>Entrada</option>
      		<option>Salida</option>
      		</select></td>
  </tr>
    <tr>
      <th scope="row"><div align="right">Fecha<font color ="red" >*</font></div></th>
      <td><input type="date" name="Fecha" style="color:white; background-color: #000000"></td>
    </tr>
    <tr>
      <th scope="row"><div align="right">Cantidad (gr)<font color ="red" >*</font></div></th>
      <td><input type="number" name="Cantidad"></td>
    </tr>
    <tr>
      <th scope="row"><div align="right">Valor<font color ="red" >*</font></div></th>
      <td><input type="number" name="Valor"></td>
    </tr>
    <tr>
      <th colspan="3" scope="row"><br><center><input type="submit" name="button" onclick="Insumos  - Alimento.php" size = 40  style=" width : 300px; heigth : 100px ;color:white; background-color: #000000"  value="Guardar"></center></th>
    </tr>
  </table>
