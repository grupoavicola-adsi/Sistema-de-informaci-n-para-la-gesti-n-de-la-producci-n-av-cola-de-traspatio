...
<center><h2>Recupere su contraseña</h2><br></center>
  ...
  <center><table  width="768" cellspacing="0" cellpadding="0" border="1  " bgcolor="">
   ...
   <td><font color="black" face="arial, verdana, helvetica">
      ...
      <center><h3>Su nueva contraseña ha sido enviada a su Email </h3></center> <br><br><br>
        <tr>
          <td colspan="4"><br><center><a  href="2.iniciodesesion.php"><input type="submit" name="button" size = 40  style=" width : 300px; heigth : 100px ;color:white; background-color: #000000"  value="Aceptar"></center></td>
        </tr>
      </table>
