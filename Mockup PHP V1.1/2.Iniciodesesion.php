...
<FORM method="post" action="validarInicioSesion.php">

  <table width="200" border="0">
    <tr>
      <td><h4 align="right"><strong>Email</strong></h4></td>

      <td><label for="correoElectronico"></label><input type="text" name="correoElectronico" id="correoElectronico" placeholder="ej: email@gmail.com" required/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><label for="password"></label><input type="password" name="password" id="pass" required/></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
...
if ($x==2)
  echo "<br><p align='center'> Debe Iniciar Sesión para poder ingresar a la Aplicación";
if ($x==3)
