...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2021 a las 02:17:27
...
INSERT INTO `autentificacionusuario`(`IdAutentificacionUsuario`,`correoElectronico`,`contraseña`) VALUES
(1,'nicolas@gmail.com','1234')
...
INSERT INTO `ciudad` (`idCiudad`, `nombreCiudad`, `Departamento_idDepartamento`, `estado`) VALUES
(1, 'MEDELLIN', 1, ''),
(2, 'ABEJORRAL', 1, ''),
(3, 'ABRIAQUI', 1, ''),
(4, 'ALEJANDRIA', 1, ''),
...
INSERT INTO `datodeproduccion` (`idDatoDeProduccion`, `RegistroUsuario_numeroIdentificacion`, `RegistroZootecnico_idRegistroZootecnico`, `fechaGestionDato`, `valorCostos`, `numeroHuevoProducido`, `TipoHuevo_idTipoHuevo`, `Producto_idProducto`, `estado`) VALUES
...
INSERT INTO `especieavicola` (`idEspecieAvicola`, `nombre`, `estado`) VALUES
(1, 'Faisan', ''),
(2, 'Gallina', ''),
(3, 'Pato', ''),
(4, 'Pavo', ''),
...
INSERT INTO `gestiondeinventario` (`idMotivimiento`, `nombre`, `descripcion`, `estado`) VALUES
...
CREATE TABLE `lote` (
  ...
  `estadolote_IdEstadoLote` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lote` (`idlote`, `fechaDeInicio`, `cantidad`, `fechaConsumoDeAlimento`, `cantidadDeAlimento`, `TipoInsumo_idTipoInsumo`, `Raza_idRaza`, `GestionDeInventario_idMotivimiento`, `DatoDeProduccion_idDatoDeProduccion`, `estadolote_IdEstadoLote`) VALUES
...
INSERT INTO `motivoinsumo` (`idMotivoInsumo`, `nombre`, `estado`) VALUES
(1, 'Galpones', ''),
(2, 'Planos galpones', ''),
(3, 'Planos sitio', ''),
(4, 'Virutas galpones', ''),
...
INSERT INTO `pais` (`idPais`, `nombrePais`, `abreviaturaPais`, `estado`) VALUES
(1, 'Colombia', 'COL', '');
...
INSERT INTO `producto` (`idProducto`, `nombreProducto`, `descripcion`, `precio`, `Proveedor_idProveedor`, `estado`) VALUES
...
INSERT INTO `proveedor` (`idProveedor`, `nombre`, `numeroTelefonico`, `Direccion`, `correoElectronico`, `Ciudad_idCiudad`, `estado`) VALUES
...
INSERT INTO `raza` (`idRaza`, `nombreRaza`, `pesoPromedio`, `estado`) VALUES
(1, 'pirocas', 100, ''),
(2, 'saraviadas', 3.2, ''),
(3, 'amarillas', 55, ''),
...
INSERT INTO `registrozootecnico` (`idRegistroZootecnico`, `fechaRegistro`, `pesoGanado`, `conversionAlimenticia`, `huevoProducido`, `huevoAveria`, `estado`) VALUES
...
INSERT INTO `tipodealimento` (`idTipodealimento`, `nombre`, `estado`) VALUES
(1, 'Maíz Blanco', ''),
(2, 'Maíz Amarillo', ''),
(3, 'Trigo', ''),
(4, 'Cebada', ''),
...
INSERT INTO `tipodebebedero` (`idTipodeBebedero`, `nombre`, `estado`) VALUES
...
INSERT INTO `tipodecomedero` (`idTipodeComedero`, `nombre`, `estado`) VALUES
...
INSERT INTO `tipodeventilacion` (`idTipodeVentilacion`, `nombre`, `estado`) VALUES
(1, 'Cenital', ''),
(2, 'Túnel', ''),
(3, 'Cuzada', '');
...
INSERT INTO `tipoinsumo` (`idTipoInsumo`, `cantidad`, `valor`, `fechaInsumo`, `MotivoInsumo_idMotivoInsumo`, `estado`) VALUES
...
ALTER TABLE `lote`
  ...
  ADD KEY `estadolote_IdEstadoLote` (`estadolote_IdEstadoLote`);
