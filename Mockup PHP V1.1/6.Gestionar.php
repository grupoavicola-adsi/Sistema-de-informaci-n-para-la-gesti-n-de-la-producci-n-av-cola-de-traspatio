...
<html lang="en" dir="ltr">
  ...
  <body background="imagenes/b.jpg">
    <header>
     ...
     <br><br><br><br> <br> <br>
    <center><h2>¿Que desea hacer?</h2><br><br><br><br><br>

        <tr>
          <td colspan="4"><br><center><a href="7.gestionartodoslotes.php"><input type="button" name="button" onclick="" size = 40  style=" width : 300px; heigth : 100px ;color:white; background-color: #000000"  value="Gestionar Lote"></center></td>
        </tr>
        <tr>
            <td colspan="4"><br><center><a href="8.gestiondeinsumos.php"><input type="button" name="button" onclick="" size = 40  style=" width : 300px; heigth : 100px ;color:white; background-color: #000000"  value="Gestionar Insumos"></center></td>
        </tr>
        <tr>
            <td colspan="4"><br><center><a href="9.Consultadehistoricos.php"><input type="button" name="button" onclick="" size = 40  style=" width : 300px; heigth : 100px ;color:white; background-color: #000000"  value="Consultar Reportes"></center></td>
        </tr>
      </table>
